...
class SelectableListRepos<T extends Object?> extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SelectableListRepos<T>> createState() =>
      SelectableListState<T>();
}

class SelectableListState<T extends Object?>
    extends ConsumerState<SelectableListRepos<T>> {
  T? selectedValue;
  ...
  Widget build(BuildContext context) {
    ...
    final items = ref.watch(dashboardReposProvider(
