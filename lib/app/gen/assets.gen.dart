...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/github_icon.png
  AssetGenImage get githubIcon =>
      const AssetGenImage('assets/icons/github_icon.png');

  /// List of all assets
  List<AssetGenImage> get values => [githubIcon];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [imageHeader];
}
